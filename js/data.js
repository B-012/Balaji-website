  ...
  packages: [
    {
      ...
      image: "images/packages/all-inclusive.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/chardham.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/rajasthan.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/goa.webp?v=2",
    ...
    },
    {
      ...
      category: "domestic",
      type: "Honeymoon / Nature",
      image: "images/packages/kerala.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/andaman.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/dubai.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/thailand.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/singapore-malaysia.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/europe.webp?v=2",
    ...
    },
    {
      ...
      category: "international",
      type: "Honeymoon / Nature",
      image: "images/packages/maldives.webp?v=2",
    ...
    },
    {
      ...
      category: "domestic",
      type: "Honeymoon / Nature",
      image: "images/packages/manali.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/northeast.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/bhutan.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/srilanka.webp?v=2",
    ...
    },
    {
      ...
      category: "domestic",
      type: "Nature / Hills",
      image: "images/packages/coorg.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/corbett.webp?v=2",
    ...
    },
    {
      ...
      category: "domestic",
      type: "Adventure / Wildlife",
      image: "images/packages/gir.webp?v=2",
    ...
    },
    {
      ...
      image: "images/packages/goa-premium.webp?v=2",
    ...
    },
    {
      ...
      category: "domestic",
      type: "Nature / Heritage",
      image: "images/packages/darjeeling-train.webp?v=2",
    ...
    },
    {
      ...
      category: "international",
      type: "Adventure / Tour",
      image: "images/packages/europe-rail.webp?v=2",
    ...
    },
    {
      ...
      category: "international",
      type: "Group / Luxury",
      image: "images/packages/europe-sightseeing.webp?v=2",
    ...
    },
    {
      ...
      category: "domestic",
      type: "Adventure / Wildlife",
      image: "images/packages/pench.webp?v=2",
    ...
    },
    {
      ...
      category: "international",
      type: "Heritage / Tour",
      image: "images/packages/egypt.webp?v=2",
    ...
    },
    {
      ...
      category: "international",
      type: "Luxury / Leisure",
      image: "images/packages/dubai-shopping.webp?v=2",
  ...
  blog: [
    {
      ...
      image: "images/packages/kolkata-travel-guide.webp?v=2",
      readTime: "5 min read",
      ...
      content: "Kolkata's Netaji Subhash Chandra Bose International Airport has expanded its connectivity immensely in recent years. Today, booking cheap international flight tickets from Kolkata to destinations like Bangkok, Singapore, Kuala Lumpur, Dubai, Doha, and Europe is easier than ever. <br><br><b>1. Bangkok, Thailand</b><br>Known for vibrant street life and ornate shrines, Bangkok is the most popular international getaway. With a flight time of just 2.5 hours, finding cheap flight booking options is a breeze. Balaji Travels offers all-inclusive tour packages covering Pattaya and Phuket.<br><br><b>2. Dubai, UAE</b><br>Dubai offers luxury shopping and stunning architecture. Direct flights take about 4.5 hours. We specialize in custom travel itineraries for Dubai, including Desert Safari and Burj Khalifa tickets.<br><br><b>3. Singapore</b><br>A global financial center with a tropical climate. Perfect for family vacation packages. Experience Universal Studios and Gardens by the Bay.<br><br><b>4. Maldives</b><br>The ultimate honeymoon destination. While direct flights are seasonal, we secure the best hotel deals and luxury resort packages for overwater villas.<br><br><b>Why Book with Balaji Travels?</b><br>As the best travel agency in Kolkata, we provide complete holiday booking services, passport and visa assistance, and travel insurance. Contact our expert flight agents today to book your international holiday packages!"
    },
    {
      ...
      image: "images/packages/chardham-yatra-tips.webp?v=2",
      readTime: "8 min read",
      ...
      content: "The Chardham Yatra is one of the most sacred Hindu pilgrimages, encompassing Yamunotri, Gangotri, Kedarnath, and Badrinath. Traversing high-altitude terrains requires careful planning. Here is your ultimate guide for the Chardham Yatra 2026.<br><br><b>1. Medical Preparation & Fitness</b><br>Start physical conditioning at least 30 days prior. Walking 4-5 km daily will help you handle the Kedarnath trek. Always consult your doctor before booking spiritual tour packages.<br><br><b>2. Essential Packing List</b><br>Weather in the Himalayas is unpredictable. Pack heavy woolens, thermal innerwear, raincoats, and comfortable trekking shoes. Do not forget a basic first-aid kit.<br><br><b>3. Biometric Registration</b><br>Mandatory for all pilgrims. As a reliable tour operator, Balaji Travels handles all registration formalities, ensuring a hassle-free experience.<br><br><b>4. Travel & Accommodation</b><br>Booking budget hotels online in these remote areas can be risky. We provide safe hotels for family, pure vegetarian meals, and experienced tour guides throughout the journey.<br><br><b>Book Your Chardham Yatra Package</b><br>Trust Balaji Travels for secure holiday bookings. We offer comprehensive Chardham yatra packages from Kolkata, including IRCTC train tickets online, flight tickets, and helicopter bookings for Kedarnath."
    },
    {
      ...
      content: "Finding the best travel deals online can be overwhelming. Many travelers believe that endlessly refreshing OTA websites is the only way to get cheap flight tickets or last minute hotel deals. Here is why consulting a full service travel agent is the smartest choice.<br><br><b>1. Access to Private Fares</b><br>Travel agencies have access to Global Distribution Systems (GDS) and corporate airline fares that are not visible to the general public. This means we can secure domestic flight booking offers and cheap international flights that beat online prices.<br><br><b>2. Guaranteed Train Tickets</b><br>Struggling with the IRCTC website? As an IRCTC authorized ticket agent, we specialize in tatkal ticket booking, railway ticket reservation, and Rajdhani/Shatabdi tickets, ensuring safe train travel.<br><br><b>3. Exclusive Hotel & Resort Deals</b><br>Through our partner networks, we secure the best hotel deals, including 5-star hotel booking and budget hotels online, often with free room upgrades or complimentary breakfasts.<br><br><b>4. Customized Holiday Packages</b><br>Skip the generic online packages. We excel at custom travel planning, offering weekend getaways, honeymoon tour packages, and corporate travel packages tailored to your exact budget.<br><br><b>Contact Us</b><br>Stop wasting time searching online. Let the top travel planner in Kolkata handle your complete holiday booking!"
    },
    {
      id: "maldives-vs-bali",
      ...
      image: "images/packages/maldives-vs-bali.webp?v=2",
      readTime: "6 min read",
    ...
    },
    {
      ...
      image: "images/packages/northeast-hidden-gems.webp?v=2",
      readTime: "7 min read",
